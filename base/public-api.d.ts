...
export * from './utils';
export { ITdAxisLine, ITdAxisLabel, ITdAxisTick, ITdSplitLine, ITdNameAxisTextStyle, ITdSplitArea, ITdAxisPointer, TdYAxisPosition, TdXAxisPosition, TdNameLocation, TdAxisType, ITdXAxisConfig, ITdYAxisConfig } from './axis/axis.interface';
