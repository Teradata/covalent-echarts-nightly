(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@covalent/echarts', ['exports', 'rxjs/operators', 'echarts/lib/echarts', 'rxjs', 'zrender/lib/svg/svg', 'echarts/lib/chart/bar', 'echarts/lib/chart/line', 'echarts/lib/chart/scatter', 'echarts/lib/chart/tree', 'echarts/lib/component/tooltip', '@angular/common', 'echarts/lib/component/toolbox', '@angular/core', '@covalent/echarts/base'], factory) :
    (factory((global.covalent = global.covalent || {}, global.covalent.echarts = {}),global.rxjs.operators,global.echarts,global.rxjs,null,null,null,null,null,null,global.ng.common,null,global.ng.core,global.covalent.echarts.base));
}(this, (function (exports,operators,echarts,rxjs,svg,bar,line,scatter,tree,tooltip,common,toolbox,core,base) { 'use strict';
