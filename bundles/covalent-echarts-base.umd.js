(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.covalent = global.covalent || {}, global.covalent.echarts = global.covalent.echarts || {}, global.covalent.echarts.base = {}), global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators, global.echarts));
    ...
    ***************************************************************************** */
     ...
     * @abstract
     */
    var TdChartAxisDirective = /** @class */ (function () {
        /**
         * @param {?} _axisOption
         * @param {?} _optionsService
         */
        function TdChartAxisDirective(_axisOption, _optionsService) {
         ...
         * @return {?}
         */
        TdChartAxisDirective.prototype.ngOnInit = function () {
            this._setOptions();
        };
        /**
         * @return {?}
         */
        TdChartAxisDirective.prototype.ngOnChanges = function () {
            this._setOptions();
        };
        /**
         * @return {?}
         */
        TdChartAxisDirective.prototype.ngOnDestroy = function () {
            this._removeOption();
        };
        /**
         * @private
         * @return {?}
         */
        TdChartAxisDirective.prototype._setOptions = function () {
            /** @type {?} */
         ...
         * @return {?}
         */
        TdChartAxisDirective.prototype._removeOption = function () {
            this._optionsService.clearOption(this._axisOption);
        };
        return TdChartAxisDirective;
    }());
    TdChartAxisDirective.decorators = [
        { type: core.Directive }
    ];
    /** @nocollapse */
    TdChartAxisDirective.ctorParameters = function () { return [
        { type: String },
        { type: TdChartOptionsService }
    ]; };
    ...
    var TdDatasetComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        TdDatasetComponent.prototype.ngOnChanges = function () {
            this._setOptions();
        };
        /**
         * @return {?}
         */
        TdDatasetComponent.prototype.ngOnDestroy = function () {
            this._removeOption();
        };
        /**
         * @private
         * @return {?}
         */
        TdDatasetComponent.prototype._setOptions = function () {
            /** @type {?} */
            var config = assignDefined(this._state, {
                id: this.id,
                source: this.source,
         ...
         * @return {?}
         */
        TdDatasetComponent.prototype._removeOption = function () {
     ...
     * @abstract
     */
    var TdSeriesDirective = /** @class */ (function () {
        /**
         * @param {?} type
         * @param {?} optionsService
         */
        function TdSeriesDirective(type, optionsService) {
        ...
        Object.defineProperty(TdSeriesDirective.prototype, "type", {
            /**
             * @return {?}
             */
            get: function () {
         ...
         * @return {?}
         */
        TdSeriesDirective.prototype.ngOnInit = function () {
            this._setOptions();
        };
        /**
         * @return {?}
         */
        TdSeriesDirective.prototype.ngOnChanges = function () {
            this._setOptions();
        };
        /**
         * @return {?}
         */
        TdSeriesDirective.prototype.ngOnDestroy = function () {
            this._removeOption();
        };
        /**
         * @param {?} option
         ...
         * @return {?}
         */
        TdSeriesDirective.prototype.setStateOption = function (option, value) {
         ...
         * @return {?}
         */
        TdSeriesDirective.prototype.removeStateOption = function (option) {
            /* tslint:disable-next-line */
         ...
         * @return {?}
         */
        TdSeriesDirective.prototype._setOptions = function () {
            /** @type {?} */
            var config = assignDefined(this._state, {
                id: this.id,
                type: this.type,
         ...
         * @return {?}
         */
        TdSeriesDirective.prototype._removeOption = function () {
            this.optionsService.removeArrayOption('series', this._state);
        };
        return TdSeriesDirective;
    }());
    TdSeriesDirective.decorators = [
        { type: core.Directive }
    ];
    /** @nocollapse */
    TdSeriesDirective.ctorParameters = function () { return [
        { type: String },
        { type: TdChartOptionsService }
    ]; };
    ...
    exports.TdChartAxisDirective = TdChartAxisDirective;
    ...
    exports.TdSeriesDirective = TdSeriesDirective;
